          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text("Non-profit Organizations" ,style: TextStyle(fontWeight: FontWeight.bold, fontSize: 25),),
                    const SizedBox(
                  height: 15,
                ),
               Containerz(),
                ...
                Text("Donation groups",style: TextStyle(fontWeight: FontWeight.bold, fontSize: 25)),
                    const SizedBox(
                  height: 15,
                ),
                ContainerzT(),
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          child: Padding(
            ...
            child: Text(text, style: TextStyle(fontSize: 17, color: Colors.white, fontWeight: FontWeight.w500),),
          ),
        ),
      ),
    );
